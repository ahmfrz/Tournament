...
def testStandingsBeforeMatches():
    ...
    [(id1, name1, wins1, matches1, t1), (id2, name2, wins2, matches2, t2)] = standings
...
def testPairings():
    ...
    if len(pairings) != 4:
        raise ValueError(
            "For eight players, swissPairings should return 4 pairs. Got {pairs}".format(pairs=len(pairings)))
    [(pid1, pname1, pt1, pid2, pname2, pt2), (pid3, pname3, pt3, pid4, pname4, pt4), (pid5, pname5, pt5, pid6, pname6, pt6), (pid7, pname7, pt7, pid8, pname8, pt8)] = pairings
